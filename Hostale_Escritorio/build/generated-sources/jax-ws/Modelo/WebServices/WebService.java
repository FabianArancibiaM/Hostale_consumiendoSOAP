 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:1939/WebService.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:1939/WebService.asmx?WSDL");
